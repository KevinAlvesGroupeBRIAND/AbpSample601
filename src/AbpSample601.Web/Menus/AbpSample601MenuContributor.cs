...
namespace AbpSample601.Web.Menus;

public class AbpSample601MenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public AbpSample601MenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<AbpSample601Resource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                AbpSample601Menus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
